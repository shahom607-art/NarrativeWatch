...
export const EDUCATION_CONTENT: EducationContent = {
  ...
  sections: [
    ...
    {
      id: "reporting-bluesky",
      title: "Reporting on Bluesky (official channels)",
      content:
        "NarrativeWatch does not report accounts on your behalf. To report content on Bluesky, use Bluesky's own safety flow: open the post on Bluesky, use the menu (⋯) → Report, and follow their prompts. When using NarrativeWatch's 'Report via Blueskys' report button, we open Bluesky's report page and copy neutral, factual suggested text to your clipboard. You can then choose whether to submit it.",
    },
    {
      id: "media-literacy",
      title: "Media literacy resources",
      content:
        "• First Draft News — verification guides and training\n• News Literacy Project — classroom and public resources\n• EU Code of Practice on Disinformation — policy context\n• Bluesky Transparency Center — platform enforcement reports\n\nCross-check claims with primary sources, note account creation dates, and look for original reporting before sharing.",
    },
  ],
};
