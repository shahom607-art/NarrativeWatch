  ...
  return (
    <>
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded border border-border bg-card py-2 text-sm hover:border-accent"
      >
        <GoogleIcon />
        {label}
      </button>
...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path
        fill="#1976D2"
        d="M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 5.571l.003-.002 6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.653-.389-3.917z"
      />
    </svg>
  );
}
